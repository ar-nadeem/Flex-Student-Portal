...
{
    public partial class OfficerEnrollTeacherCourse : System.Web.UI.Page
    {
        string RegNo;
        string Pass;
        ...
        private void Bind_Grid()
        {
            ...
            DataTable DT = new DataTable();
            myDAL objMyDal = new myDAL();
            found = objMyDal.ViewAllCourseInstructor(ref DT);
        ...
        protected void Enroll_Butt_Click(object sender, EventArgs e)
        {
            ...
            myDAL obj = new myDAL();
            int found = obj.AddCourseInstructor(RegNo, name);
            ...
            {
                Error_1.Visible = false;
                Error_1.Text = "Failed to add please check inserted data";
            }
        }
    }
}